...
"endpoint discontinuity":"path_discontinuity",
...
"simultaneous separated presence":"multi_location_identity",
...
"path_discontinuity":{"title":"Path Discontinuity","examples":("gap travel","endpoint discontinuity"),"parameters":("distance","elapsed_time","coverage")},
...
"detection_dropout":{"title":"Detection Dropout","examples":("sensor disappearance","multimodal detection loss"),"parameters":("sensor_modalities",)},
"multiple_instances":{"title":"Multiple Instances","examples":("matching instances","simultaneous copies"),"parameters":("instance_count",)},
"multi_location_identity":{"title":"Multi-location Identity","examples":("simultaneous separated presence","separated simultaneous presence"),"parameters":("site_separation","clock_tolerance")},
