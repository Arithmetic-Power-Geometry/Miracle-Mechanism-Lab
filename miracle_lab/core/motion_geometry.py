...
def _scene(key):
    scenes={
        ...
        "multiple_instances":'<circle cx="400" cy="150" r="35" class="core"/><circle cx="500" cy="150" r="35" class="core"/><circle cx="600" cy="150" r="35" class="core"/>',
        "multi_location_identity":'<circle cx="300" cy="150" r="38" class="core"/><circle cx="700" cy="150" r="38" class="core"/><path d="M338 150 H662" class="wave" stroke-dasharray="8 12"/><text x="485" y="140" class="t" font-size="20">ID</text>',
        "remote_information":'<circle cx="250" cy="150" r="50" class="barrier"/><text x="220" y="156" class="t" font-size="18">TARGET</text><path d="M310 150 Q500 60 690 150" class="wave" stroke-dasharray="5 10"/><circle cx="750" cy="150" r="34" class="core"/>',
        "future_information":'<rect x="220" y="120" width="150" height="60" class="core"/><text x="245" y="157" class="t" font-size="16">RESPONSE</text><path d="M390 150 H650" class="wave"/><polygon points="650,140 675,150 650,160" class="core"/><rect x="690" y="120" width="120" height="60" class="barrier"/><text x="707" y="157" class="t" font-size="16">TARGET</text>',
        "past_information":'<rect x="190" y="120" width="120" height="60" class="barrier"/><text x="206" y="157" class="t" font-size="16">PAST</text><path d="M330 150 H620" class="wave" stroke-dasharray="8 10"/><circle cx="700" cy="150" r="36" class="core"/><text x="670" y="156" class="t" font-size="13">RESPONSE</text>',
        ...
        "external_influence":'<circle cx="270" cy="150" r="34" class="core"/><path d="M320 150 C420 80 540 220 650 150" class="wave"/><rect x="690" y="115" width="90" height="70" class="barrier"/>',
        "environmental_influence":'<circle cx="250" cy="150" r="34" class="core"/><path d="M300 150 C420 60 560 240 700 150" class="wave"/><path d="M690 100 Q740 55 790 100 Q740 145 690 100" class="scan"/>',
        ...
        "resilience":'<polygon points="500,60 585,95 570,190 500,235 430,190 415,95" class="core"/><line x1="180" y1="90" x2="420" y2="125" class="ray"/><line x1="180" y1="150" x2="415" y2="150" class="ray"/><line x1="180" y1="210" x2="430" y2="180" class="ray"/>',
