...
def _scene(key):
    ...
    scenes={
      ...
      "scale_increase":'<g><text x="500" y="64" text-anchor="middle" class="t">SCALE INCREASE · SAME OBJECT</text><rect x="330" y="82" width="340" height="155" rx="14" class="barrier"/><path d="M350 210 H650 M360 198 V216 M400 198 V216 M440 198 V216 M480 198 V216 M520 198 V216 M560 198 V216 M600 198 V216 M640 198 V216" class="scan"/><text x="500" y="258" text-anchor="middle" class="muted">FIXED CAMERA · FIXED SCALE · GEOMETRY GROWS</text><g transform="translate(500 145)"><rect x="-34" y="-28" width="68" height="56" rx="8" class="object"/><circle cx="-13" cy="-10" r="5" class="detail"/><path d="M-22 17 L-7 2 L8 14 L22 -10" class="wave"/><animateTransform attributeName="transform" type="scale" values=".65;.65;1.65;1.65;.65" keyTimes="0;.2;.5;.8;1" dur="5s" repeatCount="indefinite"/></g><path d="M500 92 V198" class="scan" stroke-dasharray="4 8"/></g>',
