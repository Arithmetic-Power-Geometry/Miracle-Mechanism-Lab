...
def _scene(key):
    ...
    scenes={
      ...
      "scale_increase":'<g><text x="500" y="72" text-anchor="middle" class="t">MEASURED GEOMETRY INCREASES</text><rect x="390" y="92" width="220" height="125" rx="12" class="barrier"/><text x="500" y="238" text-anchor="middle" class="muted">SAME OBJECT · CALIBRATED FRAME</text><g transform="translate(500 154)"><rect x="-32" y="-27" width="64" height="54" rx="7" class="object"/><circle cx="-12" cy="-9" r="5" class="detail"/><path d="M-21 16 L-6 1 L8 13 L21 -9" class="wave"/><animateTransform attributeName="transform" type="scale" values=".55;1.55;1.55;.55" dur="4.8s" repeatCount="indefinite"/></g><path d="M370 154 H630 M500 82 V226" class="scan" stroke-dasharray="5 9"/></g>',
