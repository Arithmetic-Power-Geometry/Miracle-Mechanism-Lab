...
def _scene(key):
    ...
    scenes={
      ...
      "scale_increase":'<g><text x="500" y="58" text-anchor="middle" class="t">SCALE INCREASE</text><g transform="translate(500 155)"><path d="M0 -38 L33 -19 L33 19 L0 38 L-33 19 L-33 -19 Z" class="object"/><circle cx="0" cy="0" r="8" class="detail"/><path d="M-19 11 L-6 -5 L8 9 L20 -13" class="wave"/><animateTransform attributeName="transform" type="scale" values=".55;.55;1.65;1.65;.55" keyTimes="0;.18;.52;.82;1" dur="5s" repeatCount="indefinite"/></g><text x="500" y="270" text-anchor="middle" class="muted">SAME CENTER · GEOMETRY INCREASES</text></g>',
