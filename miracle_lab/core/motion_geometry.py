...
def _scene(key):
    ...
    scenes={
      ...
      "scale_increase":'<g><circle cx="500" cy="150" r="42" class="object"><animate attributeName="r" values="42;42;105;105;42" keyTimes="0;.18;.5;.82;1" dur="5s" repeatCount="indefinite"/></circle><circle cx="500" cy="150" r="7" class="detail"/><path d="M500 150 L542 150" class="wave"><animate attributeName="d" values="M500 150 L542 150;M500 150 L542 150;M500 150 L605 150;M500 150 L605 150;M500 150 L542 150" keyTimes="0;.18;.5;.82;1" dur="5s" repeatCount="indefinite"/></path><text x="500" y="42" text-anchor="middle" class="t">SCALE INCREASE</text><text x="500" y="278" text-anchor="middle" class="muted">CENTER FIXED · RADIUS INCREASES</text></g>',
