...
class TestInvariantBasis(unittest.TestCase):
 def test_all_14_covered(self): self.assertEqual(len(CAPABILITY_BASIS),14)
 ...
 def test_compression_summary(self):
  s=compression_summary(); self.assertEqual(s["capabilities"],14); self.assertEqual(s["basis_size"],8)
