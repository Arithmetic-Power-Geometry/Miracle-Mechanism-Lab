...
class TestTheorySynthesis(unittest.TestCase):
 def test_same_observables_can_share_experiment(self):
  a=AnalysisState("sealed-chamber appearance","frame A","local_emergence",("mass","boundary"))
  b=AnalysisState("local object appearance","frame B","local_emergence",("mass","boundary"))
  self.assertTrue(narrative_equivalence(a,b))
 def test_interpretive_frame_does_not_close_measurement_gap(self):
  s=AnalysisState("claim","rich interpretation","local_emergence",("mass","boundary"),("mass",))
